...
|---|---|---|
| 0, 1, 7, 13, 14 | this file | always |
| 2, Appendices A and B | `references/design-systems.md` | picking a design system or aesthetic, installing one |
| Appendix C | `references/liquid-glass.md` | the brief asks for glass or Apple-style translucency |
| 3, 6, 8 | `references/architecture.md` | before writing code: stack, state, icons, responsiveness, performance, accessibility, dark mode |
| 4.1 to 4.7 | `references/type-color-layout.md` | every build: typography, color, layout, shadows and cards, UI states, forms, layout discipline |
| 4.8 to 4.11 | `references/assets-content.md` | every build: images, content density, quotes and testimonials, page theme lock |
| 5 | `references/motion.md` | any scroll or motion work, `MOTION_INTENSITY` above 3 |
| 9 | `references/ai-tells.md` | before delivering: the forbidden patterns, including the em dash ban (9.G) |
| 10 | `references/vocabulary.md` | naming or choosing hero, navigation, grid, card, gallery or interaction patterns |
| 11 | `references/redesign.md` | the user has an existing site |

For a typical build, read `type-color-layout.md`, `assets-content.md` and `ai-tells.md` at minimum. The pre-flight check below cites sections from every file, so check each box against the file it names.
