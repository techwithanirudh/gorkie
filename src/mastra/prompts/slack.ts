...
- You can refer to channels by name, like \`#general\`. To make a clickable channel link, use its id as \`<#C0123ABCD>\`. Reuse ids exactly as provided in messages and tool results.
